  ...
  useEffect (()=>{
      document.addEventListener("scroll", e => {
          ...
          if (scrolled <= 362){
            ...
            setTop_p_text(['Biggest classNameifieds', 'East Asia', 'Countries', 'ABC 4512', 'We are the best', 'web development company', 'in the world', 'Coming Soon', 7])
  ...
  return (<>
    ...
    <div className='screen'>
      ...
      <div id={first_half_layer} className='firsthalf'>
          ...
          <svg version="1.1" id="transring" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 414 414" style={{enableBackground:'new 0 0 414 414', width: '430px', height: '430px', marginLeft: '10px', marginTop: '10px'}} xmlSpace="preserve">
              ...
              <g id="Dots1" className="dots-nav">
                  <g>
                      <path className={top_p_text[8] > 1 ? 'dotsst dotsfill1 progressdelay' : 'dotsst dotsfill1 normaldots'} d="M206.8,29c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S210.1,29,206.8,29z"></path>
                  </g>
                  <g>
                      <path className={top_p_text[8] > 1 ? 'dotsstro1 progressdelay2' : 'dotsstro1 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M206.8,29c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S210.1,29,206.8,29z"></path>
                  </g>
              </g>
              <g id="Dots2" className="dots-nav">
                  <g>
                      <path className={top_p_text[8] > 2 ? 'dotsst dotsfill2 progressdelay' : 'dotsst dotsfill2 normaldots'} d="M325.8,75c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S328,75,325.8,75z"></path>
                  </g>
                  <g>
                      <path className={top_p_text[8] > 2 ? 'dotsstro2 progressdelay2' : 'dotsstro2 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M325.8,75c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S327.9,74,325.9,75z"></path>
                  </g>
              </g>
              <g id="Dots3" className="dots-nav">
                  <g>
                      <path className={top_p_text[8] > 3 ? 'dotsst dotsfill3 progressdelay' : 'dotsst dotsfill3 normaldots'} d="M380.8,200c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S385.1,200,380.8,200z"></path>
                  </g>
                  <g>
                      <path  className={top_p_text[8] > 3 ? 'dotsstro3 progressdelay2' : 'dotsstro3 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M380.8,200c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S380.9,199,380.8,200z"></path>
                  </g>
              </g>
              <g id="Dots4" className="dots-nav">
                  <g>
                      <path className={top_p_text[8] > 4 ? 'dotsst dotsfill4 progressdelay' : 'dotsst dotsfill4 normaldots'} d="M325.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S328.1,325,325.8,325z"></path>
                  </g>
                  <g>
                      <path className={top_p_text[8] > 4 ? 'dotsstro4 progressdelay2' : 'dotsstro4 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M325.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S325.1,324,327.8,326z"></path>
                  </g>
              </g>
              <g id="Dots5" className="dots-nav">
                  <g>
                      <path  className={top_p_text[8] > 5 ? 'dotsst dotsfill5 progressdelay' : 'dotsst dotsfill5 normaldots'} d="M206.8,375c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S210.1,375,206.8,375z"></path>
                  </g>
                  <g>
                      <path className={top_p_text[8] > 5 ? 'dotsstro5 progressdelay2' : 'dotsstro5 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M206.8,375c-3.3,0-6,2.7-6,6s2.7,6,6,6s6-2.7,6-6S210.1,375,206.8,375z"></path>
                  </g>
              </g>
              <g id="Dots6" className="dots-nav">
                  <g>
                      <path className={top_p_text[8] > 6 ? 'dotsst dotsfill6 progressdelay' : 'dotsst dotsfill6 normaldots'} d="M88.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S88.1,325,88.8,325z"></path>
                  </g>
                  <g>
                      <path className={top_p_text[8] > 6 ? 'dotsstro6 progressdelay2' : 'dotsstro6 normaldots2'} style={{fill: 'none', stroke: 'rgb(255, 255, 255)', strokeWidth: '2', strokeMiterlimit: '10'}} d="M88.8,325c-4.3,1-7,3.7-7,7s3.7,7,7,7s7-3.7,7-7S90.1,324,88.9,325z"></path>
                  </g>
              </g>
          </svg>
          </div>
        ...
        <div style={{width: '275px', color: 'white', marginLeft: '10%', marginTop: '2vh', height: '280px'}}>
          ...
          <TextTransition
              ...
              noOverflow
          >{top_p_text[3]}</TextTransition>
          <TextTransition
              direction={text_transition_direction}
              springConfig={{ stiff: 50, damping: 20 }}
              noOverflow
          >{top_p_text[4]}</TextTransition>
          <TextTransition
              direction={text_transition_direction}
              springConfig={{ stiff: 50, damping: 20 }}
              noOverflow
          >{top_p_text[5]}</TextTransition>
          <TextTransition
              direction={text_transition_direction}
              springConfig={{ stiff: 50, damping: 20 }}
              noOverflow
          >{top_p_text[6]}</TextTransition>
          </div>
